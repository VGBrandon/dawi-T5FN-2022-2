...
public class FrmLogin extends JFrame {
	...
	void registrar() {
		...
		//El metodo find no funciona aqui ya que solo busca segund id o llave primaria
		try {
			Usuario u = em.createQuery("select u from Usuario u where u.usuario = :xusr and u.clave = :xcla", Usuario.class).setParameter("xusr", usuario).setParameter("xcla", clave).getSingleResult();
